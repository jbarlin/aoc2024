...
namespace day03
{
    ...
    int main()
    {
        ...
        long test_actual_1 = part1(day03inputs::test_input);
        ...
        long test_actual_2 = part2(day03inputs::test_input2);
        ...
        std::cout << "\t Part 1 Answer - " << std::to_string(part1(day03inputs::puzzle_input)) << std::endl;
        std::cout << "\t Part 2 Answer - " << std::to_string(part2(day03inputs::puzzle_input)) << std::endl;
